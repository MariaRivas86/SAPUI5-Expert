...
sap.ui.define([
    ...
    function (Controller, Filter, FilterOperator, ODataModel, MessageToast, MessageBox, JSONModel, History) {
        ...
        return Controller.extend("logaligroup1.Employee.controller.viewEmployee", {
            ...
            riseEmployee: function (oEvent) {
                ...
                if (!this._oDialogEmployees) {
                    ...
                    this._oDialogEmployees = sap.ui.xmlfragment("logaligroup.Employees1.fragment.DialogRiseEmployee", this);
            ...
            onAcceptRise: function (oEvent) {
                ...
                if (SalaryEmployeeStatus === "None" && SalaryDateValueStatus === "None") {
                    ...
                    var body = {
                        ...
                        Amount: parseFloat(lv_salary).toString(),
                        Waers: "EUR",
