...
sap.ui.define([
    ...
    function (Control, RatingIndicator, Label, Button ) {
        ...
        return Control.extend("logaligroup.invoices.control.ProductRating", {

            metadata: {
                properties: {
                    value: { type: "float", defaulValue: 0 }
               },
                aggregations: { 
                    _rating: {  
            ...
            init: function() {
                ...
                this.setAggregation("_button" , new Button({
                    text: "{i18n>productRatingLabelButton}",
        ...
        _onSubmit: function( oEvent ){
            ...
            setValue: function(fValue){
                this.setProperty("value", fValue, true);
                this.getAggregation("_rating").setValue(fVlaue);
